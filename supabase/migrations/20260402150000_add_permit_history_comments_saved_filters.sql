...
CREATE INDEX IF NOT EXISTS idx_permit_history_permit_id ON public.permit_history (permit_id);
CREATE INDEX IF NOT EXISTS idx_permit_history_created_at ON public.permit_history (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_saved_filters_user_page ON public.saved_filters (user_id, page);
