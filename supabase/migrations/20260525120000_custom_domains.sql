-- ============================================================================
-- Custom domains for tenant routing
--
-- The frontend resolves the current browser hostname before auth so login,
-- branding and post-login org enforcement work on both:
--   - <slug>.martinsadviser.com
--   - a customer-owned domain mapped in organization_domains
-- ============================================================================
