...
DROP POLICY IF EXISTS "org members update tasks" ON public.tasks;
CREATE POLICY "org members update tasks"
  ON public.tasks FOR UPDATE TO authenticated
  USING (public.is_org_member(org_id))
  WITH CHECK (public.is_org_member(org_id));

DROP POLICY IF EXISTS "org members delete tasks" ON public.tasks;
...
DROP POLICY IF EXISTS "org members create invoices" ON public.invoices;
...
DROP POLICY IF EXISTS "org members delete invoices" ON public.invoices;
