...
function getPtSections(): DocSection[] {
  return [
    ...
    },
    {
      ...
      description: "Área interativa para serviços, documentos, propostas e faturas",
      steps: [
        "O Portal é uma área separada onde cada cliente acessa somente os dados da própria empresa.",
        "Para convidar um cliente, vá à página de detalhe do cliente e clique em 'Convidar para Portal'.",
        "O cliente recebe por email um link seguro para acessar /portal/login.",
        "Em Serviços, o cliente pode solicitar um novo processo ou renovação, responder perguntas com prazo, enviar documentos, acompanhar etapas e assinar documentos.",
        "Em Propostas e Faturas, ele pode aprovar ou recusar propostas, consultar cobranças e pagar online.",
        "O sino de notificações avisa quando a equipe publica uma nova solicitação.",
      ],
      tips: [
        { text: "Use solicitações com prazo e checklist para centralizar o que antes era cobrado por WhatsApp ou email." },
        { text: "O cliente só altera respostas, documentos, assinaturas e decisões explicitamente disponibilizadas no portal.", variant: "warning" },
      ],
    },
    {
      id: "admin",
...
function getEnSections(): DocSection[] {
  return [
    ...
    },
    {
      ...
      color: "bg-teal-100 text-teal-600",
      title: "Client Portal",
      description: "Interactive area for services, documents, quotes, and invoices",
      steps: [
        "The Portal is a separate area where each client can access only their own company's data.",
        "To invite a client, go to the client detail page and click 'Invite to Portal'.",
        "The client receives a secure email link to access /portal/login.",
        "Under Services, clients can request a new process or renewal, answer dated questions, upload documents, track stages, and sign documents.",
        "Under Quotes and Invoices, they can approve or decline quotes, review charges, and pay online.",
        "The notification bell alerts them whenever the team publishes a new request.",
      ],
      tips: [
        { text: "Use dated requests and checklists to centralize follow-ups previously handled through WhatsApp or email." },
        { text: "Clients can only change answers, documents, signatures, and decisions explicitly exposed in the portal.", variant: "warning" },
      ],
    },
    {
      id: "admin",
...
function getEsSections(): DocSection[] {
  return [
    ...
    },
    {
      ...
      description: "Área interactiva para servicios, documentos, propuestas y facturas",
      steps: [
        "El Portal es un área separada donde cada cliente accede solamente a los datos de su propia empresa.",
        "Para invitar a un cliente, vaya a la página de detalle y haga clic en 'Invitar al Portal'.",
        "El cliente recibe por correo un enlace seguro para acceder a /portal/login.",
        "En Servicios puede solicitar un nuevo proceso o renovación, responder preguntas con plazo, enviar documentos, seguir etapas y firmar documentos.",
        "En Propuestas y Facturas puede aprobar o rechazar propuestas, consultar cobros y pagar en línea.",
        "La campana de notificaciones avisa cuando el equipo publica una nueva solicitud.",
      ],
      tips: [
        { text: "Use solicitudes con plazo y checklists para centralizar seguimientos antes hechos por WhatsApp o correo." },
        { text: "El cliente solo modifica respuestas, documentos, firmas y decisiones disponibles explícitamente en el portal.", variant: "warning" },
      ],
    },
    {
      id: "admin",
