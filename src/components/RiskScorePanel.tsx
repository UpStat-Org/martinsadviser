    ...
    return (
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-semibold">{t("risk.title")}</CardTitle>
        </CardHeader>
        ...
        <div className={`flex items-center gap-4 rounded-md ${style.bg} p-4`}>
          ...
          <div className="flex-1">
            <div className="flex items-baseline gap-1">
              <span className={`text-2xl font-semibold tracking-tight tabular-nums ${style.text}`}>{score.score}</span>
